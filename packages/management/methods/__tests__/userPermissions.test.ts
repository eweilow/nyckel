...
import { getManagementUserPermissions } from "../userPermissions";
...
describe("getManagementUserPermissions", () => {
  ...
  it("should wait for rate limiting correctly", async () => {
    ...
    await getManagementUserPermissions("id", config);
  ...
  it("should fail if error", async () => {
    ...
    const promise = getManagementUserPermissions("id", config);
  ...
  it("should return correctly", async () => {
    ...
    const data = await getManagementUserPermissions("id", config);
    expect(((fetch as any) as jest.Mock).mock.calls).toMatchSnapshot();
